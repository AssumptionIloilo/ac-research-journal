 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query getVolumes($limit: Int = 10, $page: Int = 1) {\n  Volumes(limit: $limit, page: $page, sort: \"publishedDAte\") {\n    docs {\n      id\n      title\n      volumeCover {\n        alt\n        url\n      }\n      slug\n      publishedDate\n    }\n  }\n}\n\nquery getVolumeBySlug($slug: String) {\n  Volumes(limit: 1, where: {slug: {equals: $slug}}) {\n    docs {\n      id\n      slug\n      title\n      volumePdf {\n        url\n        alt\n      }\n      volumeCover {\n        alt\n        url\n      }\n      about\n      publishedDate\n    }\n  }\n}"): (typeof documents)["query getVolumes($limit: Int = 10, $page: Int = 1) {\n  Volumes(limit: $limit, page: $page, sort: \"publishedDAte\") {\n    docs {\n      id\n      title\n      volumeCover {\n        alt\n        url\n      }\n      slug\n      publishedDate\n    }\n  }\n}\n\nquery getVolumeBySlug($slug: String) {\n  Volumes(limit: 1, where: {slug: {equals: $slug}}) {\n    docs {\n      id\n      slug\n      title\n      volumePdf {\n        url\n        alt\n      }\n      volumeCover {\n        alt\n        url\n      }\n      about\n      publishedDate\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query getHomeData($newsLimit: Int!) {\n  news: allNews(limit: $newsLimit, sort: \"publishedDate\") {\n    docs {\n      id\n      title\n      publishedDate\n      readTime\n      slug\n      featureImage {\n        alt\n        url\n      }\n    }\n  }\n  featuredVolume: Volumes(limit: 1, sort: \"publishedDate\") {\n    docs {\n      id\n      title\n      about\n      slug\n      volumePdf {\n        url\n        alt\n      }\n      volumeCover {\n        alt\n        url\n      }\n      publishedDate\n    }\n  }\n}"): (typeof documents)["query getHomeData($newsLimit: Int!) {\n  news: allNews(limit: $newsLimit, sort: \"publishedDate\") {\n    docs {\n      id\n      title\n      publishedDate\n      readTime\n      slug\n      featureImage {\n        alt\n        url\n      }\n    }\n  }\n  featuredVolume: Volumes(limit: 1, sort: \"publishedDate\") {\n    docs {\n      id\n      title\n      about\n      slug\n      volumePdf {\n        url\n        alt\n      }\n      volumeCover {\n        alt\n        url\n      }\n      publishedDate\n    }\n  }\n}"];

...
export const Hero: FC<HeroProps> = (props) => {
  ...
  return (
    <div className="relative h-screen flex flex-col gap-y-6 item-center justify-center bg-[#E6E6FA] pt-12">
      {/* Icons */}
      <Icons.star1 className="absolute z-20 top-20 right-10 w-[75px] md:top-36 md:right-28 md:w-[120px]" />
      <Icons.star2 className="absolute z-20 w-[75px] bottom-44 right-44 hidden md:block" />
      <Icons.star3 className="absolute bottom-20 left-8 z-20 w-[56px] md:w-[100px] md:bottom-40 md:left-40" />
      ...
      {/* Backdrop */}
      <div className="bg-green-500 absolute inset-0 grid grid-cols-2">
        {/*  Background */}
        <div className="absolute inset-0 bg-primary-500 z-10 bg-opacity-80" />
        {/* Collage */}
        <div
          style={{
      ...
      {/* Content */}
      <div
        className={container({ class: 'relative flex flex-col gap-y-2 z-10' })}
      >
        ...
        <p className="text-primary-100 text-center leading-[42px] text-[28px] font-[300] z-10 px-5 md:text-[48px] md:leading-[64px] overflow-hidden">
          Welcome to{' '}
          <span className="font-bold text-secondary-400">{typewriter}!</span>
        </p>
